...
| `version/0` | Version-derived client peer ID prefix (`ET0-6-3`, BEP 20) |
...
| [BEP 20](https://www.bittorrent.org/beps/bep_0020.html) | Peer ID conventions | **Full** | Version-derived prefix (`ET0-6-3` for package 0.6.3); one runtime-generated 20-byte identity per application instance |
