defmodule BittorrentTest do
  ...
  test "pieces statistic" do 
    ...
    assert PiecesStatistic.handle_call(:rare, nil, %{1 => 1, 2 => :priority}) == {:reply, 2, %{1 => 1}}
    assert PiecesStatistic.handle_call(:rare, nil, %{1 => 1, 2 => :priority, 3 => {:allowed_fast, 9}}) == {:reply, 3, %{1 => 1, 2 => :priority}}
    assert PiecesStatistic.handle_call(:rare, nil, %{2 => :priority, 3 => {:allowed_fast, 9}}) == {:reply, 3, %{2 => :priority}}
